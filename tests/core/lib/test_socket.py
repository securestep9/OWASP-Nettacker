...
class TestSocketMethod:
    ...
    def test_create_tcp_socket(self, mock_create_context, mock_socket):
        ...
        mock_sock.settimeout.assert_called_with(TIMEOUT)
        mock_sock.connect.assert_called_with((HOST, PORT))
        mock_create_context.assert_called_once()
        mock_context.wrap_socket.assert_called_with(mock_sock, server_hostname=HOST)
